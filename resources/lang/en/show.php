...
return [
    ...
    'or' => 'or',
    'pageDescription' => 'Define :text, meaning of :text, definition of :text, etymology of :text, origin of :text, Chinese slang :text, Chinese chatspeak :text, Chinese cyber-lang :text, Chinese internet slang :text at Lingbox.cn',
    'pageTitle' => 'Meaning of ":text"',
    'siblings' => 'Sibling entries',
    'singleDesc' => 'created this at :created. Updated at :updated',
