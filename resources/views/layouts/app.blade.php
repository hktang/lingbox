...
<head>
    ...
    <script>
      (adsbygoogle = window.adsbygoogle || []).push({
        google_ad_client: "ca-pub-1457521094963432",
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @if (Auth::guest())
                            <li><a href="{{ route('login') }}">{{__('login.login')}}</a></li>
                            <li><a href="{{ route('register') }}">{{__('register.register')}}</a></li>
                        @else
                            <li class="dropdown">
